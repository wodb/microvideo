 ...
 * @public
 */
export const identitycode = text => {
 ...
 * @public
 */
export const datestr = text => {
  return !/Invalid|NaN/.test(new Date(text).toString())
}

export const passwd = text => {
...
export const zhennumStr = text => {
  return REGEX_RULE.zhennumstr.test(text)
}

export const zhennumStr1 = text => {
